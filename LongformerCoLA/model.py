...
def build_real_longformer(src_vocab_size, label_vocab_size, src_seq_len, d_model, N, h, dropout, d_ff):
    src_embed = InputEmbeddings(d_model, src_vocab_size)
    src_pos = PositionalEncoding(d_model, src_seq_len, dropout)
        
    longformer = CustomLongformer(30000, 4096, 768, 12, 12,3072, 0.1)
